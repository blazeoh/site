    ...
    if (togglePassword && passwordInput) {
      ...
      togglePassword.addEventListener('click', () => {
        ...
        togglePassword.innerHTML = passwordVisible
          ? `<svg id="eye-off-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.94 10.94 0 0 1 12 19c-6 0-10-7-10-7a21.81 21.81 0 0 1 5.06-6.06M9.5 9.5a3 3 0 0 1 4.24 4.24M3 3l18 18"/><circle cx="12" cy="12" r="3"/></svg>`
          : `<svg id="eye-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#888" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7z"/></svg>`;
